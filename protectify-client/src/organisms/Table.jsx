                      ...
                      <Grid item xs={6}>
                        ...
                        >
                          ...
                          <Grid item xs={6}>
                            <h2>
                              {statistics.media
                                ? String(statistics.media).substring(0, 4)
                                : ""}
                            </h2>
                          </Grid>
                        </Grid>
                      ...
                      <Grid item xs={6}>
                        ...
                        >
                          ...
                          <Grid item xs={6}>
                            <h2>
                              {statistics.varianza
                                ? String(statistics.varianza).substring(0, 4)
                                : ""}
                            </h2>
                          </Grid>
                        </Grid>
                      ...
                      <Grid item xs={6}>
                        ...
                        >
                          ...
                          <Grid item xs={6}>
                            <h2>
                              {statistics.mediana
                                ? String(statistics.mediana).substring(0, 4)
                                : ""}
                            </h2>
                          </Grid>
                        </Grid>
                          ...
                          <Grid item xs={6}>
                            <h2>
                              {statistics.desviacion_estandar
                                ? String(statistics.desviacion_estandar).substring(0, 4)
                                : ""}
                            </h2>
                          </Grid>
                        </Grid>
